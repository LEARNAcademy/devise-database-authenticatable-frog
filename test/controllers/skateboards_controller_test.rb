...
class SkateboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create skateboard" do
    assert_difference('Skateboard.count') do
      post skateboards_url, params: { skateboard: { brand: @skateboard.brand, length: @skateboard.length, model: @skateboard.model, user_id: @skateboard.user_id } }
    end
  ...
  test "should update skateboard" do
    patch skateboard_url(@skateboard), params: { skateboard: { brand: @skateboard.brand, length: @skateboard.length, model: @skateboard.model, user_id: @skateboard.user_id } }
